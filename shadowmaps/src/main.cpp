...
GLuint aPosLocation = 0; // location set in col_vert.glsl
...
static void init() {
	...
	// If there were any OpenGL errors (call this for debugging)
...
static void render()
{
	...
	// Get light and eye projection matrices
...
int main(int argc, char **argv)
{
	...
	window = glfwCreateWindow(640, 480, "ArcBall & Shadow Maps", NULL, NULL);
	if(!window) {
		glfwTerminate();
		return -1;
	}
